...
const NAME_ERROR_HINT = "الاسم يجب أن يحتوي على حروف عربية فقط";
const PHONE_ERROR_HINT = "رقم الهاتف يجب أن يحتوي على أرقام فقط";
...
export default function RegisterScreen() {
  ...
  const allValid = nameValid && phoneValid && emailValid && passwordValid;
  ...
  return (
    <AuthScreenShell>
      ...
      <ValidatedField
        ...
        hasInvalidChar={nameHasInvalidChar}
        isValid={isValidArabicName}
        errorHint={NAME_ERROR_HINT}
      ...
      <ValidatedField
        ...
        hasInvalidChar={phoneHasInvalidChar}
        isValid={isValidPhone}
        errorHint={PHONE_ERROR_HINT}
