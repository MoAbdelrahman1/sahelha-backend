...
export const FALLBACK_SERVICES: GovernmentService[] = [
  {
  ...
  },
  {
    ...
    "dialects_qa": [
      "عايز أستخرج قبالة طلاق كمبيوتر؟",
      "ايه أوراق وثيقة الطلاق المميكنة؟"
    ]
  },
  {
    ...
    "steps": [
      "طلب الخدمة إلكترونياً",
      "رفع الوثائق وسداد الرسوم",
      "استلام القيد العائلي"
    ],
    "dialects_qa": [
      "عايز أعمل قيد عائلي؟",
      "ايه الورق المطلوب للقيد العائلي للجيش؟"
    ]
  },
  {
  ...
  },
  {
    ...
    "steps": [
      "إدخال رقم اللوحة أو رخصة القيادة",
      "الاطلاع على المخالفات أو تقديم التظلم",
      "الدفع إلكترونياً والتوصيل"
    ],
    "dialects_qa": [
      "عايز أعرف مخالفات العربية؟",
      "ازاي أتظلم على مخالفات المرور؟"
    ]
  },
  {
    "id": "CRA-TAX-CARD",
  ...
  },
  {
    ...
    "related_services": [
      "فتح ملف ضريبي واستخراج البطاقة الضريبية"
    ],
    "fees_and_delivery": "رسوم استخراج مستخرج السجل التجاري 75 جنيه مصري ويستخرج فورياً.",
    "steps": [
      "تقديم الطلب بالسجل التجاري أو المنصة",
      "دفع الرسوم",
      "استلام مستخرج السجل"
    ],
    "dialects_qa": [
      "عايز أستخرج سجل تجاري؟",
      "ايه ورق السجل التجاري للشركة؟"
    ]
  },
  {
    ...
    "steps": [
      "حجز موعد عبر تطبيق أرغب في عمل توكيل أو مصر الرقمية",
      "التوجه لمكتب التوثيق لاستلام التوكيل"
    ],
    "dialects_qa": [
  ...
  },
  {
    ...
    "steps": [
      "حجز موعد التوثيق",
      "حضور البائع والمشتري لمكتب الشهر العقاري",
      "توقيع العقد واستلامه"
    ],
    "dialects_qa": [
      "عايز أوثق عقد بيع عربية؟",
      "ايه أوراق توثيق عقد بيع السيارة بالشهر العقاري؟"
    ]
  },
  {
    "id": "PASSPORT-EGYPT",
    ...
    "steps": [
      "شراء نموذج جواز السفر بقسم الجوازات",
  ...
  },
  {
    ...
    "related_services": [
      "إضافة الأفراد والأبناء على بطاقة التموين"
    ],
    ...
    "steps": [
      ...
      "تفعيل البطاقة واستلام الرقم السري"
    ],
    "dialects_qa": [
      "عايز أطلع بطاقة تموين؟",
      "ازاي أعمل فصل اجتماعي في التموين؟"
    ]
  },
  {
    ...
    "related_services": [
      "إصدار ونقل بطاقة التموين"
    ],
    "fees_and_delivery": "الخدمة مجانية عبر منصة مصر الرقمية ومكاتب التموين.",
    "steps": [
      "تقديم طلب الإضافة",
      "التحقق من استحقاق الأسرة",
      "إضافة المستفيدين"
    ],
    "dialects_qa": [
      "عايز أضيف عيالي على التموين؟",
      "ازاي أضيف المواليد الجديدة في بطاقة التموين؟"
    ]
  },
  {
    ...
    "steps": [
      "إدخال الرقم القومي واسم الأم",
      "عرض الرقم التأميني والمدد المسجلة فورياً"
    ],
    "dialects_qa": [
      "عايز أعرف الرقم التأميني بتاعي؟",
      "ازاي أستعلم عن مدة التأمينات؟"
    ]
  },
  {
    ...
    "steps": [
      "شراء كراسة الشروط وسداد المقدم بالبريد",
      "رفع المستندات إلكترونياً",
      "الاستعلام الميداني والتخصيص"
    ],
    "dialects_qa": [
      "عايز أقدم على شقة في الإسكان الاجتماعي؟",
      "ايه أوراق التقديم على شقق سكن لكل المصريين؟"
    ]
  }
];
